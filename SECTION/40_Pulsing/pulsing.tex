...
\begin{figure}[tbp]
  \centering
  % \input{10_Figures/TikZ/device.tikz}
  \includegraphics[width=80mm]{10_Figures/External/device.eps}
...
\begin{figure}[tbp]
  \centering
  \includegraphics[width=86mm]{10_Figures/Supplemental_OT.pdf}
...
\begin{figure}[tbp]
  \centering
  \includegraphics[width=86mm,trim=90mm 45mm 80mm 35mm, clip 
  ]{10_Figures/Supplemental_Device.pdf}
...
\begin{figure*}[tbp]
  \centering
  % \input{10_Figures/TikZ/protocol.tikz}
  \includegraphics[width=160mm]{10_Figures/External/protocol.eps}
...
One single BM follows the sketched process of \cref{fig:flowchart} (see also 
...
\begin{figure*}[tbp]
  \centering
  % \input{10_Figures/TikZ/flowchart.tikz}
  \includegraphics[]{10_Figures/External/flowchart.eps}
...
\begin{figure}[tbp]
  \centering
  % \input{10_Figures/TikZ/duty_cycle.tikz}
  \includegraphics[]{10_Figures/External/duty-cycle.eps}
...
\begin{figure*}[tbp]
  \centering
  % \input{10_Figures/TikZ/duty_m04.tikz}
  \includegraphics[]{10_Figures/External/duty-m04.eps}
...
\begin{figure*}[tbp]
  \centering
  % \input{10_Figures/TikZ/duty_m05.tikz}
  \includegraphics[]{10_Figures/External/duty-m05.eps}
  \caption{Evolution of averaged voltage differences $\DV_{y}$ (left column; 
    ARF associated) and $\DV_{z}$ (right column; AS associated) for three 
    different pulsing frequencies $\fp$ and different duty percentages at 
...
\begin{figure*}[tbp]
  \centering
  % \input{10_Figures/TikZ/duty_m06.tikz}
  \includegraphics[]{10_Figures/External/duty-m06.eps}
  \caption{Evolution of averaged voltage differences $\DV_{y}$ (left column; 
    ARF associated) and $\DV_{z}$ (right column; AS associated) for three 
    different pulsing frequencies $\fp$ and different duty percentages at 
...
In \cref{fig:duty-m04,fig:duty-m05,fig:duty-m06} the results of the BMs over 
...
\begin{figure*}[tbp]
  \centering
  % \input{10_Figures/TikZ/temperature.tikz}
  \includegraphics[]{10_Figures/External/temperature.eps}
...
\begin{figure*}[tbp]
  \centering
  % \input{10_Figures/TikZ/avg_end_over_duty.tikz}
  \includegraphics[]{10_Figures/External/avg-end-over-duty.eps}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\bibliography{Publications-Pulsing.bib}
