...
% All three plots for $\Dy_{i} = \SI{-0.6}{\mm}$ and $\Dy_{i}= \SI{-0.4}{\mm}$
% (\cref{fig:duty-m04,fig:duty-m06}) show qualitatively and quantitatively the
% same behavior as the results for $\Dy_{i}=\SI{-0.5}{\mm}$
% (\cref{fig:duty-m05}).
