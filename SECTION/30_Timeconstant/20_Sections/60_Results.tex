...
axial $\ez$ (see \cref{subfig:TC-F_y} and \cref{subfig:F_z}). Nevertheless, 
\cref{subfig:TC-F_z} and \cref{subfig:res_DV_z} also show similar shapes. We want 
to stress again, that the amplitudes of \cref{fig:TC-DV_vs_dy} are not comparable 
...
\begin{figure}[ht]
  ...
  same length as in \cref{subfig:TC-F_y}.}\label{fig:DV_vs_dy}
\end{figure}%
