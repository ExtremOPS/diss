...
\begin{figure}[H]
  ...
  \begin{subfigure}{\figWidth}
    ...
    % \includegraphics[width=\subfigWidth]{/avgF_y_vs_dy.eps}
    \includegraphics[]{/avgF_y_vs_dy.pdf}
  \end{subfigure}%
  \begin{subfigure}{\figWidth}
    \centering
    % \input{\relPath/10_Figures/TikZ/avgF_z_vs_dy.tikz}
    % \includegraphics[width=\subfigWidth]{/avgF_z_vs_dy.eps}
    \caption{$F_{z}$ [\si{\pico\newton}]}\label{subfig:TC-F_z}
    \includegraphics[]{/avgF_z_vs_dy.pdf}
  \end{subfigure}%
