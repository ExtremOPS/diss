...
focal plane (see \cref{fig:laserpath}). It is possible to resolve the movement 
...
\begin{figure}[H]
  ...
  \cite{Lamprecht2016,Lamprecht2017}.}\label{fig:laserpath}
\end{figure}

For the $xy$ position the laser beam is focused onto the QPDxy (see also 
\cref{fig:laserpath}) such that the spot diameter is about five times smaller 
