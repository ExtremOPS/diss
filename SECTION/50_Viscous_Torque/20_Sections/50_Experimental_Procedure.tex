...
(results are not shown) \cite{Lamprecht2013}.
...
\cite{Lakaemper2015,Lamprecht20132016}. The same procedure was used here to measure the 
...
smaller (see \cref{fig:VT-Fig5,fig:Fig6}).  The detection algorithm had a threshold 
value of 3 (signal-to-noise ratio) for indicating peaks in determined power 
spectrum.  \cref{fig:VT-Fig8}b depicts the corresponding calibration power spectrum 
of \cref{fig:VT-Fig8}a.
...
\cref{fig:VT-Fig4}). The difference in wavelength from \cref{fig:Fig4} ($\lambda 
...
acoustofluidic device and the water-immersion objective \cite{Lamprecht20132016}.  
\Cref{fig:VT-Fig4} was observed with a standard microscope lens that did not need 
...
\cite{Lamprecht20132016}.\label{fig:VT-Fig8}}
\end{figure}
%%%%%%%%%%%%%%%%%%%
