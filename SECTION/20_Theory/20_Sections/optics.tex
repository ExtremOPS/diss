...
\begin{figure}[tbp]
  ...
  \caption{Fast Fourier Transform (FFT) of Brownian motion along the $\ex$ 
  direction from a trapped \SiO~particle with radius $\SI{1.03}{\um}$. The gray 
shaded region \SIrange{20}{6000}{\hertz} depicts the data points taken for the 
fit (\textcolor{red}{red}).}
