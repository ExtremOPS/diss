...
$c=\SI{299792458}{\m\per\s}$ in vacuum. Outside of vacuum the speed of light 
has a smaller magnitude. The refractive index relates the speed of light of 
vacuum $c$ to any other material $c_{\Box}$
\begin{equation}
  c_{\Box} = \frac{c}{n_{\Box}}.
...
\begin{equation}
  \alpha = \frac{4\pi f \tilde{\refraction}}{c} = 
  \frac{4\pi}{\lal}\tilde{\refraction}\quad\text{with}\quad\lal=\frac{c}{f}
  \label{eq:TO-alpha}
\end{equation}
...
only the results of \cname{Celliers2000} compared to \cname{Moreau2015} match 
this interpolation. But \cname{Celliers2000} used an inherently different 
