...
\end{equation}
where $\delta$ is also known as VBL thickness.
...
VBL thickness $\sfrac{R}{\delta}$, the ratio of the particle 
to the acoustic wavelength $\sfrac{R}{\wavelength_{\MR{a}}} = 
\sfrac{\R\,f}{\cfl}$, and the ratio of the VBL thickness to 
...
then VBL thickness $R \gg \delta$ and, secondly, the 
...
VBL can be formed The ARF is defined as the gradient of a 
potential
\begin{equation}
...
a local time-averaged streaming in the VBL of the particle 
