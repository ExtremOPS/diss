...
\nomenR{\refraction_{\Box}}{index of refraction}
\nomenR{\normal, \normalvector}{surface normal}
\nomenR[\m\per\s]{\vel_{i}, \velvector}{fluid velocity}
\nomenR[\newton]{\force^{\MR{rad}_{i}}, \FARF}{acoustic radiation force}
\nomenR[\newton]{\force^{\MR{drag}_{i}}, \FAS}{drag force from acoustic 
streaming}
...
% greek alphabet
\nomenG[\radian]{\theta_{\Box}}{ray angle measured to surface normal}
...
\nomenG[\meter\square\per\s]{\kinematicviscosity}{kinematic viscosity}
...
\nomenS{\Box_{i}}{$i$-th coordinate direction of Cartesian system}
...
\nomenA{US}{ultrasound}
\nomenA{VBL}{viscous boundary layer}
